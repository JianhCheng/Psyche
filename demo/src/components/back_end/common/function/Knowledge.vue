  ...
  <div class="contain">
    ...
    <el-scrollbar class="scrollbar-wrapper">
      ...
      <el-table :data="dataList" border style="width: 95%">
        ...
        <el-table-column prop="isopen" label="是否公开" width="150">
        </el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope" width="200">
            ...
            <el-button size="mini" type="danger" @click="handleDelete(scope.row, 'KonwledgeList')">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!--对话框  编辑-->
    <el-dialog title="知识点列表编辑" :visible.sync="editVisible">
      <el-form :model="Listform" ref="ruleF">
        ...
        <el-form-item label="题库分类" :label-width="formLabelWidth">
          <el-select v-model="Listform.category" placeholder="请选择题库分类" style="float:left">
            <el-option label="官方习题" value="OFFICIAL"></el-option>
            <el-option label="个人习题" value="PERSONAL"></el-option>
          </el-select>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submitKList()">确 定</el-button>
      </div>
    </el-dialog>

    <!-- 对话框  详情 -->
    <el-dialog title="知识点详细题目" :visible.sync="outerVisible" width="1300px">

      <!-- 编辑 -->
      <el-dialog title="知识点编辑" :visible.sync="innerVisible" width="60%">
        <el-form :model="Detailform">
          ...
          <el-form-item label="学科" :label-width="formLabelWidth">
            <el-input  v-model="Detailform.subject" :value="Detailform.subject"></el-input>
          </el-form-item>

          <el-form-item label="重点" :label-width="formLabelWidth">
            <el-input  v-model="Detailform.point" :value="Detailform.point"></el-input>
          </el-form-item>

          <el-form-item label="章节" :label-width="formLabelWidth">
            <el-input  v-model="Detailform.chapter" :value="Detailform.chapter"></el-input>
          </el-form-item>
          ...
          <el-form-item label="解释" :label-width="formLabelWidth">
            <el-input type="textarea"  v-model="Detailform.explanation" :value="Detailform.explanation"></el-input>
          </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="updateKDetail">确 定</el-button>
        </div>
      </el-dialog>
      ...
      <el-scrollbar class="scrollbar-wrapper" style="overflow-x: hidden;">
        <el-table :data="detailList" style="width: 100%">
          <el-table-column prop="qbid" label="知识点id" width="100">
          </el-table-column>
          <el-table-column prop="id" label="知识点id" width="100">
          </el-table-column>
          ...
          <el-table-column prop="type" label="知识点类型" width="100">
          </el-table-column>
          <el-table-column prop="explanation" label="解释" width="600">
          </el-table-column>
          <el-table-column label="操作">
            <template slot-scope="scope" width="200">
              <el-button size="mini" type="primary" @click="handleDetailEdit(scope.row)">编辑</el-button>
              <el-button size="mini" type="danger" @click="handleDelete(scope.row, 'KonwledgeDetail')">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    updateKDetail() {
      const params = {
        body: {
          ...
          explanation: this.Detailform.explanation,
          img: this.Detailform.img,
        },
      };
      console.log(params)
      this.$http.post("/zcxy/konwledgeDetail/updateKDetail", params.body).then((res) => {
    ...
    getDetailList() {
      ...
      this.$http.get("/zcxy/konwledgeDetail/list", params).then((res) => {
    ...
    deleteItem(table, id) {
      ...
      console.log(params)
      this.$http.get("/zcxy/konwledgeList/deleteItem", params).then((res) => {
    ...
    handleDetailEdit(item) {
      ...
      this.fileList = []
      console.log(item)
      if (item.img != '' && item.img != '/' &&item.img !="None") {
        let i = {
          name: item.img,
          url: item.img
        }

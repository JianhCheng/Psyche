<template>
    <div class="collect">
        <div class="collect-head">文章收藏</div>
        <el-divider></el-divider>
        <el-card class="collect-body" v-for="(item, i) in collectPaperList" :key="i">
                ...
                <div class="collect-body-content">
                    <img :src="item.img" class="collect-cody-img">
...
export default {
    ...
    methods: {
        getCollectPaperList() {
            ...
            this.$http.get("/zcxy/paperList/getCollectPaper", params).then((res) => {
                this.collectPaperList =res.data.data
